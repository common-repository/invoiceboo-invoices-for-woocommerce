...
// DESCRIPTION :
//
// Class to create DataMatrix ECC 200 barcode arrays for InvoiceBoo_TCPDF class.
...
class Datamatrix {
	...
	/**
	 * Barcode array to be returned which is readable by InvoiceBoo_TCPDF.
	 * @protected
	 */
...
// -----------------------------------------------------------------------------
	...
	/**
	 * Returns a barcode array which is readable by InvoiceBoo_TCPDF
	 * @return array barcode array readable by InvoiceBoo_TCPDF;
	 * @public
	 */
